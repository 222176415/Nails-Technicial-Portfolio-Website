...
export default function Footer() {
    ...
    { 
      name: 'WhatsApp', 
      icon: Smartphone, // Lucide uses Smartphone (or MessageSquare). WhatsApp brand color applied.
      link: 'https://wa.me', 
  ...
  return (
   <footer className="relative z-10 bg-dark-card border-t border-dark-border px-6 py-12 md:px-12 md:py-13">
         ...
         {/* Footer Bottom */}
         <div className="border-t border-dark-border pt-6 flex flex-wrap items-center justify-between gap-3">
           <span className="text-[10px] text-text-faint tracking-[0.5px]">
